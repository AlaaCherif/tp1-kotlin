...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn.setOnClickListener {
            var response: String = getMessage(txtEmail.text.toString(), txtPass.text.toString())
            Toast.makeText(
                applicationContext,
                response,
                Toast.LENGTH_LONG
            ...
            if (response == "Credentials correct") {
                var intent = Intent(it.context, WelcomeActivity::class.java)
    ...
    fun getMessage(email: String, password: String): String {
